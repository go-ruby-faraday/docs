...
The public API lives at the module root (`github.com/go-ruby-faraday/faraday`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `faraday`, while the surface follows
...
```go
import "github.com/go-ruby-faraday/faraday"
```
...
- **[pkg.go.dev/github.com/go-ruby-faraday/faraday](https://pkg.go.dev/github.com/go-ruby-faraday/faraday)**

The module's [README](https://github.com/go-ruby-faraday/faraday#readme) carries worked
