...
Contributions are welcome. `go-ruby-faraday/faraday` is built to a small set of
...
The library is in [`github.com/go-ruby-faraday/faraday`](https://github.com/go-ruby-faraday/faraday).
This documentation site is in [`github.com/go-ruby-faraday/docs`](https://github.com/go-ruby-faraday/docs).
